...
val v19: Float = 5.75f
//val v20: String = `1.414` - кавычки, неподдерживаемые kotlin, лучше убрать их и будет тип Doube
...
//val v32 = “🤯” - кавычки, неподдерживаемые kotlin, лучше сделать двойные, как для String ""
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
//val v34 = ‘65535’ - кавычки, неподдерживаемые kotlin, лучше убрать и будет тип Int
